...
if __name__ == "__main__":
    ...
    train_img_path = "/mnt/data4TBa/elh33168/data/BFW/small_bfw_train.csv"
    folder_path = '/mnt/data4TBa/elh33168/data/BFW/bfw-cropped-aligned/'

    bfw_dataset = BFW(train_img_path, folder_path, iat_type="ethnic_gender")
    deb_dataloader = DataLoader(bfw_dataset, batch_size=batch_size, shuffle=True)
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(adv, 'saved_models/eg_class_' + str(epoch) + '.pt')
        torch.save(deb, 'saved_models/eg_deb_' + str(epoch) + '.pt')
